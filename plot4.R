...
# Divide the plot in four sub-plots and set the margines
par(mfrow = c(2,2), mar = c(4,4,4,4), oma = c(0,0,1,0))

# Make the four sub plots
plot(housingTrimmed1$Global_active_power ~ housingTrimmed1$datetime, type = "l", ylab = "Global Active Power", xlab = "")
plot(housingTrimmed1$Voltage ~ housingTrimmed1$datetime, type = "l", ylab = "Voltage", xlab = "datetime")
plot(housingTrimmed1$Sub_metering_1 ~ housingTrimmed1$datetime, type = "l", ylab = "Energy sub metering",xlab = "")
# Add lines to the "Energy sub metering plot"
...
plot(housingTrimmed1$Global_reactive_power ~ housingTrimmed1$datetime, type = "l", ylab = "Global_rective_power", xlab = "datetime")
